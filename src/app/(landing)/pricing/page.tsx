...
const Page = () => {
    ...
    return (
        <div className='bg-brand-25 py-24 sm:py-32'>
            <MaxWidthWrapper>
                <div className='mx-auto max-w-2xl sm:text-clip'>
                    <Heading className='text-center'>Simple no-trick pricing</Heading>
                    <p className='mt-6 text-base/7 text-gray-600 max-w-prose text-center text-pretty'>Pidgey hate subscriptions And chances are, you do too. That's why we offer lifetime access to PeekingPidgey for one-time payment</p>
                </div>
                <div className='bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none'>
                    <div className='p-8 sm:p-10 lg:flex-auto'>
                        ...
                        <p className='mt-6 text-base/7 text-gray-600'>Imvest once in PeekingPidgey and transform how you monitor your ANYTHING forever.
                            Get instant alerts, track critical metrics and never miss a beat in your business growth.</p>
                        ...
                        <div className='rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16'>
                            <div className='mx-auto max-w-xs py-8'>
                                ...
                                <p className='mt-6 text-xs leading-5 text-gray-600'>
                                    Secure payment. Start monitering in minutes
                                </p>
                            </div>
                        </div>
