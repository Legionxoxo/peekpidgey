        ...
        () => [
            {
                ...
                cell: () => <span>{category.name || "Uncategorized"}</span> /*what to render  */
            },
            {
            ...
            /* spread the fields created by user from api like new user sales etc */
            ...(data?.events[0]
