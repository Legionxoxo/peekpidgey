            ...
            <div className='flex flex-col items-center'>
                {isPending || !isPaymentSuccessful ? (
                    ...
                    <div className='relative aspect-video border border-gray-200 w-full overflow-hidden rounded-lg bg-gray-50'>
                        <img src="/brad-asset-heart.png" alt="heart" className='h-full w-full object-cover' />
                    </div>
                    ...
                    <div className='mt-6 flex flex-col items-center gap-1 text-center'>
                        ...
                        <p className='text-gray-600 text-sm/6 text-pretty'>Thank you for Upgrading to Pro and supporting PeekingPidgey.
                            Your account has been upgraded.</p>
                    </div>
